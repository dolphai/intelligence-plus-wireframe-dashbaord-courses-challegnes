...
interface ProfessionalCourseDashboardCardProps {
  course: ProfessionalCourse;
}

const ProfessionalCourseDashboardCard: React.FC<ProfessionalCourseDashboardCardProps> = ({ course }) => {
  const gradients = [
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-between h-full">
          <div>
            ...
            <div className="flex gap-4 items-center mb-2">
              <div className="text-xs text-green-600 font-semibold">Progress: {course.ProfessionalProgress}%</div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
            <div 
              ...
              style={{ width: `${course.ProfessionalProgress}%` }}
            ></div>
          </div>
...
export default ProfessionalCourseDashboardCard;
