...
interface SchoolCourseDashboardCardProps {
  course: SchoolCourse;
}

const SchoolCourseDashboardCard: React.FC<SchoolCourseDashboardCardProps> = ({ course }) => {
  const gradients = [
...
export default SchoolCourseDashboardCard;
