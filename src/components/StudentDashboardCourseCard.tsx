...
const StudentDashboardCourseCard: React.FC<StudentDashboardCourseCardProps> = ({ course }) => {
  ...
  return (
    <div className="flex gap-6 items-center bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-5 border border-gray-100 hover:shadow-md transition-shadow duration-200">
      {/* Thumbnail */}
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-lg font-black text-gray-800 leading-6 tracking-tight mb-1 line-clamp-2">{course.title}</h3>
