...
import StudentDashboardCourseCard from '../../components/student/StudentCourseDashboardCard';
import StudentChallengeDashboardCard from '../../components/student/StudentChallengeDashboardCard';
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm flex flex-col h-full min-h-[420px]">
            ...
            <div className="flex flex-col gap-6 flex-1">
              {challenges.map((challenge) => (
                <StudentChallengeDashboardCard key={challenge.id} challenge={challenge} />
              ))}
            </div>
            <div className="mt-4 flex justify-center">
